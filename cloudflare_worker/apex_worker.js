// ð  APEX MOVE â Bot Telegram pe Cloudflare Workers (v4.3)
...
const AGENTS = {
  ...
  editare: { emoji: "\u{1F3AC}", label: "Editare Video",
    prompt: "Esti EXPERTUL in editare video cu DaVinci Resolve (gratuit). " + BRAND + " Dai instructiuni pas-cu-pas clare pentru: import clipuri, taieturi pe timeline, color grading rapid (Lift/Gamma/Gain, LUT-uri gratuite), tranzitii profesionale, text si titluri animate (Fusion), adaugare muzica si sincronizare pe beat, export optimizat pentru Instagram Reels si TikTok (1080x1920, H.264/H.265, 30fps). Format raspuns: Pas / Actiune exacta / Setare concreta. Specialitate: editare continut sportiv dinamic \u2014 taieturi rapide, culori vii, energic. Sfaturi si pentru Windows si Mac." },
};
